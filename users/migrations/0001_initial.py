    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_manager', models.BooleanField(blank=True, default=False, null=True, verbose_name='менеджер')),
                ('email', models.EmailField(max_length=254, unique=True, verbose_name='почта')),
                ('token', models.CharField(blank=True, max_length=100, null=True, verbose_name='Токен')),
                ('id', models.IntegerField(default=0, editable=False, primary_key=True, serialize=False, verbose_name='id_клиента')),

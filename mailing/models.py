...
class Mailing(models.Model):
    ...
    customers = models.ManyToManyField(Customer, verbose_name='Контакты клиентов')
    messages = models.ForeignKey(Message, on_delete=models.CASCADE, verbose_name='Сообщение', null=True, blank=True)
